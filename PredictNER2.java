...
public class PredictNER2 {

    // private static final String MODEL_PATH = "ecolab_address_20230828_3.model.ser.gz";
    ...
    public static void analyzeWithFile(String modelPath){
    ...
    public static void analyzeWithVanillaData(String modelPath){
    ...
    public static void analyzeWithArgs(String modelPath, String address){
    ...
    public static void main(String[] args){
        ...
        analyzeWithArgs(modelPath, address);
